...
final cartControllerProvider =
  ...
  final cartActionState = ref.watch(cartStateProvider.notifier);
  return CartController(cartService, cartActionState);
});
...
// cart state provider
final cartStateProvider = StateProvider<CartState>((ref) => CartStateIdle());
